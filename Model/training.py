...
def train_and_evaluate(X, y):
    """Trains a model to predict stock movement (up/down), incorporating sentiment analysis."""
    ...
    # Apply sentiment analysis (choose "social" for Twitter or "news" for Yahoo Finance)
    X["sentiment"] = X["text"].apply(lambda text: analyze_sentiment(text, source="news"))  # Change "social" if using tweets
    ...
    # Train model using XGBClassifier
